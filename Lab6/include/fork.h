...
struct pt_regs {
    ...
    //thus making sure that we will return to the pc address after performing exception return.
    
    unsigned long pstate;       
    //process state; This field will be copied to spsr_el1 by the kernel_exit and 
