...
#define MEM_START    0x0             // 0x10000000 - 0x20000000 
#define MEM_END      0x3C000000      // let BUDDY_MEMORY use 0x0 ~ 0x3C000000 (SPEC)
...
void memory_reserve(void*, void*,int);
